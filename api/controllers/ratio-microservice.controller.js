...
const schemaJSON = require('../schemas/ratio-microservice.schema');
const messages = require('../messages/ratio-microservice.messages');

const schema = new mongoose.Schema(schemaJSON);
const logger = log4js.getLogger('ratio-microservice.controller');

const model = mongoose.model('ratioMicroservice', schema, 'ratioMicroservice');
